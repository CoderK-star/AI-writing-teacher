...
ユーザーは Zene 上で小説や記事など、作品を書きながら、チャットで AI 講師に相談できます。チャットには、独自の資料を使ってRAGを導入済み。
...
将来的に小説執筆に特化したLLMモデルが出てきたら、このプロジェクトにまた着手するかもしれないけどまあ、そこまでのモチベが続くか分からない、というのが正直な感想です。
